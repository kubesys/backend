...
@ServiceDefinition
public class McmfService extends HttpBodyHandler {

	public Object solveBase(JsonNode json) throws Exception {
		return MockUtil.getJson();
	}
	
	public Object solveBase2(JsonNode json) {
