...
import io.github.kubesys.backend.datafrk.operators.CheckTable;
...
import io.github.kubesys.backend.datafrk.operators.QueryDataBuilder;
...
public class SQLMapperClient {
	...
	public static final Logger m_logger = Logger.getLogger(SQLMapperClient.class.getName());
	...
	public SQLMapperClient() throws Exception {
		this(createDataContext());
	}
	
	public SQLMapperClient(DataContext context) {
		super();
